...
import Identité_graphique_UFC from '../views/Identité_graphique_UFC.vue'
...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/Identité_graphique_UFC', name: 'Identité_graphique_UFC', component: Identité_graphique_UFC },
