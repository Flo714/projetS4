...
import Identite_graphique_UFC from '../views/Identite_graphique_UFC.vue'
...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/Identite_graphique_UFC', name: 'Identite_graphique_UFC', component: Identite_graphique_UFC },
