<template>
  ...
  <p class="opacity-80 text-sm lg:text-base lg:mr-[500px] ">"Schoolastique" est un projet où j'ai collaboré avec 4 autres étudiants pour créer un site internet conseillant des produits aux étudiants. En utilisant des liens d'affiliation, les étudiants sont dirirger vers ces produits. Le site offrira des conseils sur une variété de produits allant des fournitures scolaires aux gadgets technologiques, tout en permettant aux étudiants de partager leurs expériences et recommandations.
