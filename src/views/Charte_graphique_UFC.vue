...
<main class="text-white font-raleway mx-6">
  ...
  <div class="my-10 xl:my-20 xl:grid xl:grid-cols-2 xl:items-center xl:justify-center z-20">
    <div class="z-20">
      <img src="/public/images/Charte_UFC.png" class="w-[70%] mx-auto lg:max-w-[700px] xl:mx-auto shadow-white" alt="Image de présentation de la charte graphique de l'université de Franche-Comté">
  ...
  <div class="lg:my-40 mx-28 xl:mx-20 z-20">
    ...
    <div class="grid grid-flow-row-dense grid-cols-[repeat(auto-fit,minmax(280px,1fr))] justify-items-center items-center gap-10 lg:gap-36 xl:gap-64 ">
      <div class="lg:mx-20 z-20">
        <img class="max-w-[200px]  lg:max-w-md xl:max-w-lg" src="/public/images/Couleurs.jpg" alt="Image des couleurs de la charte graphique de l'université de Franche-Comté">
      </div>
      <div class="lg:mx-20 z-20">
        <img class="max-w-[200px] lg:max-w-md xl:max-w-lg" src="/public/images/Applications_varie.jpg" alt="Image de mock-up de la charte graphique de l'université de Franche-Comté">
      </div>
      <div class="lg:mx-20 z-20"> 
        <img class="max-w-[200px]  lg:max-w-md xl:max-w-lg" src="/public/images/Restriction.jpg" alt="Image des restrictions de la charte graphique de l'université de Franche-Comté">
      </div>
    </div>
  </div>
