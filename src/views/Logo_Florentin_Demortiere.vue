<template>
  ...
  <main class="text-white font-raleway">
    ...
    <div class="text-[10px] italic flex justify-center mx-2 my-1 mt-20 lg:text-xs xl:text-base ">
        <p class="">Portfolio 2024 © - Florentin Demortiere - <RouterLink class="hover:font-black duration-300 underline" to="/mentions_legales">Mentions Légales</RouterLink></p>
      </div>
  </main>
</template>
