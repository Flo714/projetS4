  ...
  <main class="bg-black text-white font-raleway font-semibold">
    ...
    <div class="my-20">
      <div class="animate__animated animate__backInLeft mx-10 lg:mx-16">
        ...
        <div class="z-20">
          <p class="text-sm md:text-lg my-6 xl:text-xl xl:m-20 xl:pr-20 lg:mx-10 lg:my-10 lg:text-lg xl:-mt-3 opacity-50">Je m'appelle Florentin Demortiere, j'ai 20 ans et je suis un étudiant en MMI (Métiers du Mulitmédia et de l'Internet). Je suis passionné par le design graphique, l'audiovisuel et les animations</p>
        </div>
      </div>
      ...
      <div class="wrapper grid grid-flow-row-dense grid-cols-[repeat(auto-fit,minmax(320px,1fr))] justify-items-center items-center gap-10 pt-40 pb-10 lg:mx-10 relative z-20 justify-center" id="travaux">
        ...
        <RouterLink class="card" to="/Charte_graphique_UFC">
              ...
              <div class="info">
                <h3 class="text-xl font-bold">Charte graphique UFC</h3>
                <div class="flex justify-center my-3">
                  <button class="bg-white text-black border-white border-2 font-bold px-3 py-2 rounded-full hover:bg-transparent hover:text-white duration-300 text-sm">En savoir plus</button>
                </div>
              </div>
        ...
        <RouterLink class="card" to="/drone_video">
          ...
          <div class="info">
            <h3 class="text-xl font-bold">Mini-Film drone</h3>
            <div class="flex justify-center my-3">
              <button class="bg-white text-black border-white border-2 font-bold px-3 py-2 rounded-full hover:bg-transparent hover:text-white duration-300 text-sm">En savoir plus</button>
            </div>
          </div>
        ...
        <RouterLink class="card" to="/match_UFC">
          ...
          <div class="info">
            <h3 class="text-xl font-bold">Rencontre Universitaire</h3>
            <div class="flex justify-center my-3">
              <button class="bg-white text-black border-white border-2 font-bold px-3 py-2 rounded-full hover:bg-transparent hover:text-white duration-300 text-sm">En savoir plus</button>
            </div>
          </div>
        ...
        <RouterLink class="card" to="/CDLR">
          <img class="object-cover" src="/public/images/CDLR.png" alt="Image de présentation des flyers Végétale Vallée">
          <div class="info">
            <h3 class="text-xl text-center font-bold">Création Flyer Chalon dans la rue</h3>
            <div class="flex justify-center my-3">
              <button class="bg-white text-black border-white border-2 font-bold px-3 py-2 rounded-full hover:bg-transparent hover:text-white duration-300 text-sm">En savoir plus</button>
            </div>
          </div>
      ...
      <div class="relative mt-10 pt-10 lg:mt-28 lg:pt-16 lg:flex lg:gap-20 lg:mx-28 z-20" id="perso">
        <img class="w-40 mx-auto rounded-sm md:w-48 lg:w-64 xl:w-80" src="/public/images/IMG_2248.png" alt="Photo de Florentin Demortiere">
        ...
        <div class="flex justify-center my-6 lg:hidden">
            <a class="bg-white flex gap-2 px-3 py-2 md:my-12 lg:px-4 lg:py-3 xl:py-4 rounded-full place-items-center hover:bg-transparent first-child:hidden border-2 text-black font-bold text-xs md:text-base lg:text-lg xl:text-xl   duration-300 hover:text-white" href="/public/CV.pdf" target="_blank">Voir mon CV</a>
        </div>
      </div>
      <div class="lg:flex mt-28 mb-28 mx-16 lg:mx-20  lg:ml-40 z-20 xl:ml-52 xl:my-40 relative" id="contact">
        ...
        <div class="border-b-2 lg:border-b-0 lg:border-r-2 lg:text-lg lg:mx-8 mb-8 pl-4">
          <p class="lg:text-xl xl:text-2xl">Localisation</p>
          <div class="mt-6 mx-2 lg:mx-4 xl:mr-32 xl:my-6">
            <p class="text-xs opacity-70 lg:text-base xl:text-lg">1 Rue Charles Goguel</p>
            <p class="text-xs opacity-70 my-4 lg:text-base xl:text-lg">25200 Montbéliard</p>
          </div>
        </div>
      ...
      <div class="text-[10px] italic flex justify-center mx-2 my-1 mt-20 lg:text-xs xl:text-base ">
        <p class="">Portfolio {{currentYear}} © - Florentin Demortiere - <RouterLink class="hover:font-black duration-300 underline" to="/mentions_legales">Mentions Légales</RouterLink></p>
      </div>
  </main>
</template>
