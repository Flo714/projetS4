  ...
  <main class="bg-black text-white font-raleway font-semibold">
    ...
    <div class="my-20">
      <div class="animate__animated animate__backInLeft mx-10 lg:mx-16">
        ...
        <div class="z-20">
          <p class="text-sm md:text-lg my-6 xl:text-xl xl:m-12 xl:pr-20 lg:mx-10 lg:my-10 lg:text-lg xl:-mt-3 opacity-50">Je m'appelle Florentin Demortiere, j'ai 20 ans et je suis un étudiant en MMI (Métiers du Mulitmédia et de l'Internet). Je suis passionné par le design graphique, l'audiovisuel et les animations</p>
        </div>
      </div>
