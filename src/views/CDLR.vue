  ...
  <div class="lg:my-40 mx-16 ">
    ...
    <div class="grid grid-flow-row-dense grid-cols-[repeat(auto-fit,minmax(280px,1fr))] justify-items-center items-center gap-10 lg:gap-36 ">
      <div class="lg:mx-10 z-20">
        <img class="max-w-[200px]  lg:max-w-xs"  src="/public/images/Flyer_recto_fleur.jpg" alt="Image d'un flyer">
      </div>
      <div class="lg:mx-10 z-20">
        <img class="max-w-[200px] lg:max-w-xs" src="/public/images/vegetoradicaux.jpg" alt="Image d'un flyer">
      </div>
       <div class="lg:mx-10 z-20">
        <img class="max-w-[200px] lg:max-w-xs" src="/public/images/vegetosceptique.jpg" alt="Image d'un flyer">
      </div>
    </div>
  </div>
